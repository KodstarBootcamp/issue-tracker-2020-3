...
//        return all;
//    }
//    public static List<String> returnApplicantSNNList(String filePath){
//        List<String>all = new ArrayList<>();
//        try(BufferedReader br = new BufferedReader(new FileReader(filePath))) {
//            StringBuilder sb = new StringBuilder();
//            String line = br.readLine();
...
//                newApplicant.setSSN(line.split(",")[0]);
//                sb.append(System.lineSeparator());
//                line = br.readLine();
//
//                //System.out.println(i++);
//
//                all.add(newApplicant.getSSN());
//            }
//        }catch (Exception e){
//            e.printStackTrace();
//        }
...
//        List<String>all = new ArrayList<>();
//        try(BufferedReader br = new BufferedReader(new FileReader("src/test/java/gmibank/test-data/test-data.txt"))) {
//            StringBuilder sb = new StringBuilder();
//            String line = br.readLine();
//            int i = 0;
//            while (line != null) {
...
//    }
//    public static String returnSSn(){
//        List<String>all = new ArrayList<>();
//        try(BufferedReader br = new BufferedReader(new FileReader("src/test/java/gmibank/test-data/test-data.txt"))) {
//            StringBuilder sb = new StringBuilder();
//            String line = br.readLine();
...
//        return all.get(all.size()-1);
//    }
//    public static List<String> returnAllSSn(){
//        List<String>all = new ArrayList<>();
//        try(BufferedReader br = new BufferedReader(new FileReader("src/test/java/gmibank/test-data/test-data.txt"))) {
//            StringBuilder sb = new StringBuilder();
//            String line = br.readLine();
